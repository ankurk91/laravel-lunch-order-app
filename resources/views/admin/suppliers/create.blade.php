...
@section('content')
  ...
  <form method="POST" action="{{route('admin.suppliers.store')}}">
    ...
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Create a new supplier</h5>
          ...
          <div class="col-md-6">
            <div class="form-group required">
              ...
              <input type="number" class="form-control {{ $errors->has('primary_phone') ? ' is-invalid' : '' }}"
                     ...
                     placeholder="Primary phone" value="{{old('primary_phone')}}" required>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" class="form-control {{ $errors->has('alternate_phone') ? ' is-invalid' : '' }}"
                     ...
                     placeholder="Alternate phone" value="{{old('alternate_phone')}}">
        ...
        <div class="text-right">
          <button type="submit" class="btn btn-primary">
            <i class="fas fa-plus-square"></i> Create supplier
          </button>
        </div>
      </div>
    </div>
